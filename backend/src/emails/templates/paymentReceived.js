...
function paymentReceivedTemplate(name,amount,blockchain, token, walletAddress, transactionHash, todayDate, transactionURL) {
  const templateHtml = `
<!DOCTYPE html>
<html lang="en">
  <head>
        ...
        >
          <div style="width: 100%; max-width: 489px; margin: 0 auto;">
            ...
            <p
              ...
              "
            >
            Great news! 🎉 You have successfully received a crypto payment via Resmic. Here are the transaction details:
            ...
            <li>Transaction Hash: <a href=${transactionURL}> ${transactionHash}</li></a>
            
            <br><br>
            You can check your payment history anytime in your dashboard:
            <br><br>
                
            View Transaction → <a href="dashboard.resmic.com" style="text-decoration: none;">Dashboard</a>
...
module.exports = paymentReceivedTemplate